  ...
  return (
    ...
    <div className='bg w-full flex md:justify-center justify-between items-center p-1 h-24 navBar'>
        ...
        <div className='flex-relative relative'>
          ...
          {toggle && (
            <ul className='z-10 fixed top-0 -right-2 p-3 w-[50vw] h-screen shadow-2xl md:hidden list-none flex flex-col justify-start items-end rounded-md blue-glassmorphism'>
