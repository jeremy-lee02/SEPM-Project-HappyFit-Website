  ...
  return (
    ...
    <div className='pt-24 w-full h-auto relative'>
        ...
        <div className='absolute w-full h-auto bottom-0'>
            <h1 className='sm:text-4xl font-bold text-black flex justify-center'>Anywhere, Anytime!</h1>
            <h2 className='sm:text-2xl font-bold text-black flex justify-center'>Since 2022.</h2>
        </div>
  </div>
  )
}
